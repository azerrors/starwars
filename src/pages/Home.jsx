...
function Home() {
  ...
  return (
    <div className="relative h-[52rem]">
      <div className=" absolute left-0 top-0 homebg h-full w-full bg-[url('../../public/homebg.jpg')] bg-cover bg-center bg-no-repeat mix-blend-soft-light blur-sm dark:mix-blend-difference"></div>
